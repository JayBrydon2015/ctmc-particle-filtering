...
runs_table_dictionary = {
    "N": [5000, 5000, 5000, 5000, 30000, 5000, 5000, 5000, 5000],
    "delta_t": [0.01, 0.01, 0.01, 0.01, 0.01, 1, 0.002, 0.01, 0.01],
    "K": [300, 300, 300, 900, 300, 300, 300, 300, 300],
    "J": [1, 8, 10000, 1000, 1000, 1000, 1000, 1000, 1000],
    "TV": [False, False, False, False, False, False, False, True, True],
    "C": [1, 1, 1, 1, 1, 1, 1, 0.5, 2],
    "plot_bin_counts": [False, False, False, True, False, False, False,
                        False, False],
}
...
for i in range(num_runs): # Run A, B, C, etc
    ...
    plot_bin_counts = runs_table_dictionary["plot_bin_counts"][i]
...
num_gp_runs = 7
runs_table_dictionary = {
    "N": [50000, 50000, 50000, 50000, 300000, 50000, 50000],
    "delta_t": [0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01],
    "K": [300, 300, 300, 900, 300, 300, 300],
    "J": [1, 8, 10000, 1000, 1000, 1000, 1000],
    "l": [0.8, 0.8, 0.8, 0.8, 0.8, 1.5, 0.8],
    "C": [1, 1, 1, 1, 1, 1, 2]
}
